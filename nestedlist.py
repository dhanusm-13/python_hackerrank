...
The lowest grade of 37.2 belongs to Tina. The second lowest grade of 37.21 belongs to both Harry and Berry, so we order their names
...
lowest_score=sorted(set(scores))[1]
names=sorted([name for name ,score in records if score==lowest_score])
